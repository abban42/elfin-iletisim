export default async function handler(req, res) {
  ...
  try {
    ...
    const ALLOWED = ['public/devices.json', 'public/promos.json', 'public/chatbot_kb_extra.json', 'public/chatbot_kb_main.json', 'public/tariffs_custom.json', 'public/banners.json', 'public/evinternet_docs.json', 'public/evinternet_tariffs.json', 'public/youtube.json'];
